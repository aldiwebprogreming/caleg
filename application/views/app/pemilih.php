    ...
    <div class="col-md-12">
      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          ...
          <a href="<?=base_url('app/grafig_pemilih') ?>" class="btn btn-primary">Grafik Pemilih </a>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" action="<?= base_url('app/act_addpemilih') ?>">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      ?>
                      <form method="post" action="<?= base_url('app/act_editpemilih') ?>">
...
<!-- 
        ...
        <div class="modal fade" id="exampleModalhapus<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Hapus Pemilih Anda</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                ...
                <form method="post" action="<?= base_url('app/act_hapuspemilih') ?>">
                  <input type="hidden" name="id" value="<?= $data['id'] ?>">
