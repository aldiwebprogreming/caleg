    ...
    <div class="col-md-12">
      ...
      <div class="box box-danger">
        <div class="box-header">
          <h3 class="box-title">  <i class="fa fa-users"></i> Data Saksi Caleg</h3>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Alamat Saksi</label>
                    <textarea class="form-control" name="alamat_saksi" required="Masukan alamat lengkap tim sukses anda"></textarea>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="kec" id="kecdapil" required>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Username Saksi</label>
                    <input type="text" name="username" class="form-control" required>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Password Saksi</label>
            ...
            <tbody>
                      ...
                      <div class="modal-body">
                       <!--   <form method="post" action="<?= base_url('app/act_editdapil') ?>"> -->
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">FOTO :</label>
                          <p>
                            <a href="<?= base_url('assets/berkas/') ?><?= $data['foto'] ?>" target="_blank">
                              <img src="<?= base_url('assets/berkas/') ?><?= $data['foto'] ?>" alt="foto" class="img-thumbnail" >
                            </a>
                          </p>
                        </div>
              ...
              <div class="modal fade" id="exampleModaledit<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Edit Data Saksi Caleg</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div class="modal-body">
                     <form method="post" action="<?= base_url('app/act_editsaksi') ?>" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1">Alamat Saksi</label>
                        <textarea class="form-control" name="alamat_saksi" required="Masukan alamat lengkap Saksi anda"><?= $data['alamat_saksi'] ?></textarea>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <img id="image-preview" src="<?= base_url('assets/berkas/') ?><?= $data['foto'] ?>" alt="foto" class="img-thumbnail" >
                      </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form method="post" action="<?= base_url('app/hapus_saksi') ?>">
                    <input type="hidden" name="id" value="<?= $data['id'] ?>">
