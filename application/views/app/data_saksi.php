            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Alamat Tim Sukses</label>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Username Tim Sukses</label>
                    <input type="text" name="username" class="form-control" required>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Password Tim Sukses</label>
            ...
            <tbody>
              ...
              <?php foreach($ts as $data){ ?>
                <tr>
                  ...
                  <td>
                    <?php 
                    $jml_pml = $this->db->get_where('tbl_pemilih', ['kode_ts' => $data['kode_ts']])->num_rows();
                    ?>
                    <a href="<?= base_url('app/pemilih_ts/') ?><?= $data['kode_ts'] ?>" class="text-center"><?= $jml_pml ?></a>
                  </td>
                  <td>
                ...
                <div class="modal fade" id="exampleModaledit<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                       <form method="post" action="<?= base_url('app/act_editts') ?>" enctype="multipart/form-data">
